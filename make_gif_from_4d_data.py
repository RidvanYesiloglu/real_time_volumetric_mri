...
def main(all_vols, pt_id, ax_cr_sg, plot_most_fluc=False):
    ...
    #     if plot_most_fluc:
    #         if ax_cr_sg == 0:
    #             plt.suptitle(f"Most Fluctuating Axial Images ({pt_id}, Time Point: {t:3d})")
    #         elif ax_cr_sg == 1:
    #             plt.suptitle(f"Most Fluctuating Coronal Images ({pt_id}, Time Point: {t:3d})")
    #         elif ax_cr_sg == 2:
    #             plt.suptitle(f"Most Fluctuating Sagittal Images ({pt_id}, Time Point: {t:3d})")
    #     else:
    #         if ax_cr_sg == 0:
    #             plt.suptitle(f"Axial Images ({pt_id}, Time Point: {t:3d})")
    #         elif ax_cr_sg == 1:
    #             plt.suptitle(f"Coronal Images ({pt_id}, Time Point: {t:3d})")
    #         elif ax_cr_sg == 2:
    #             plt.suptitle(f"Sagittal Images ({pt_id}, Time Point: {t:3d})")        
